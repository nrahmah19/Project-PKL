...
<body>
    ...
    <div id="halaman">
        ...
        <p>Sehubungan dengan akan dilaksanakannya <b>Kegiatan {{$m->judul_penelitian}}</b>, pada tanggal
            <b>{{$m->tanggal_mulai}}</b>
            s.d <b>{{$m->tanggal_selesai}}</b>, di <b>{{$m->alamat}}</b> dengan ini saya mohon
        ...
        <table id="tabel">
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$m->nim}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Nama</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$m->nama}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Kategori Kegiatan</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$m->jenis_penelitian}}</td>
            </tr>
