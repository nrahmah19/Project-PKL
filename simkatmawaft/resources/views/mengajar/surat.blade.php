...
<body>
    ...
    <div id="halaman">
        ...
        <table>
            ...
            <td style="width: 5%;">:</td>
            <td style="width: 75%;"><b>{{$mengajar->id}}</b></td>
        </table>
        ...
        <p>Sehubungan dengan akan dilaksanakannya <b>Kegiatan {{$mengajar->nama_program}}</b>, pada tanggal
            <b>{{$m->tanggal_mulai}}</b>
            s.d <b>{{$mengajar->tanggal_selesai}}</b>, di <b>{{$mengajar->alamat}}</b> dengan ini saya mohon
        ...
        <table id="tabel">
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$mengajar->nim}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Nama</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$mengajar->nama}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Kategori Kegiatan</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$mengajar->jenis_program}}</td>
            </tr>
